...
class DataHandling:
    ...
    def data_processing(self, variante):
        ...
        try:
            ...
            cortes_df = txt_df[txt_df['Tipo da Nota'].str.contains('CS|CA', regex=True)].copy()
            ...
            # prazo_sap_str pode conter dois formatos distintos:
            #   - ISO:  YYYY-MM-DD HH:MM:SS  (quando concl_desejada já vem completo)
            #   - BR:   DD.MM.YYYY HH:MM:SS  (quando concatenado com hora_sap)
            # Parsear os dois formatos separadamente evita o UserWarning do pandas.
            mask_iso = prazo_sap_str.str.contains(
